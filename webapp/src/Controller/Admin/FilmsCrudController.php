...
class FilmsCrudController extends AbstractCrudController
{
	...
	public function configureFields(string $pageName): iterable
	{
		...
		return [
			...
			ChoiceField::new('genre')->setChoices($genres)->allowMultipleChoices()->setColumns(4),
			TextField::new('realisateur')->setColumns(5),
			TextField::new('acteurs')->setColumns(7),
			IntegerField::new('age_mini')->setEmptyData(0)->setColumns(2),
			TimeField::new('duree')->setColumns(2),
			DateField::new('date_ajout')->setEmptyData(new \DateTime("now"))->setColumns(3),
